...
void MGEDemo::_initializeScene()
{
    ...
    testCube1 = new GameObject("cube1", glm::vec3(5,0,-7));
    testCube1->setMesh(cubeMesh);
    testCube1->setMaterial(litMat);
    testCube1->rotate(0.46, glm::vec3(0,1,0));
    _world->AddChild(testCube1);

    testCube1 = new GameObject("cube1", glm::vec3(-3,0,-5));
    testCube1->setMesh(cubeMesh);
    testCube1->setMaterial(litMat);
    testCube1->rotate(0.46, glm::vec3(0,1,0));
    _world->AddChild(testCube1);
    ...
    testCube1 = new GameObject("cube1", glm::vec3(-7,0,-5));
    testCube1->setMesh(cubeMesh);
    testCube1->setMaterial(litMat);
    testCube1->rotate(0.46, glm::vec3(0,1,0));
    _world->AddChild(testCube1);

    testCube1 = new GameObject("cube1", glm::vec3(-3,0,7));
    testCube1->setMesh(cubeMesh);
    testCube1->setMaterial(litMat);
    testCube1->rotate(0.46, glm::vec3(0,1,0));
    _world->AddChild(testCube1);
